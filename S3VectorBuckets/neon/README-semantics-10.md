Here's a Python implementation of semantic inheritance for our tokens:
...
This way, each semantic token automatically carries all the contextual information from its hypernym chain - just like how a Python subclass inherits methods and properties!
